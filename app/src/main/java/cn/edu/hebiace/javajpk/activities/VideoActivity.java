...
public class VideoActivity extends AppCompatActivity {
    ...
    private Button                 playBtn, backBtn;         //用于开始/暂停和退出的按钮
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        url = (String) getIntent().getCharSequenceExtra(getString(R.string.videopath));
        ...
        playBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
                    ...
                    mediaPlayer.start();
                    playBtn.setBackgroundResource(R.drawable.ic_pause_circle_outline_black_24dp);
                }
            }
        });
